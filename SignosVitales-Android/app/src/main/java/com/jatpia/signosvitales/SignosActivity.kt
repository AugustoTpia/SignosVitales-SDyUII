...
class SignosActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       // bluetoothJhr = BluetoothJhr(MainActivity::class.java, this)
        ...
        val frec = findViewById<TextView>(R.id.frec)
        val pso = findViewById<TextView>(R.id.pso)
                ...
                this@SignosActivity.runOnUiThread(java.lang.Runnable {
                    if(mensaje.isEmpty() && mensaje == null){
                        ...
                        if(count == 2 || aux > "36.0"){
                            ...
                            editor.setText(aux)
                            frec.setText("Frecuencia cardiaca: $aux PPM")
                            pso.setText("Oxigenación: $aux%")
                            offHilo = false
                            ...
                            try {
                                ...
                                postData.put("temp", "$aux")
                                postData.put("pulso", "$aux")
                                postData.put("pso", "$aux")
